...
| `layer2_model_card.md` | Layer 2 IF/LOF/DBSCAN ensemble: pollution-event features, weak-label eval, limitations |
| `fusion_spec.md` | Trust score function, severity penalties, escalated/quarantined status rule |
